...
$body = @{
    query = 'query { service(id: "91e2a6fe-1b8d-446f-9a42-abb655a3f398") { id name serviceInstances(first: 3) { edges { node { id serviceName latestDeployment { id status url staticUrl createdAt updatedAt } source { image repo } startCommand buildCommand } } } } }'
}
